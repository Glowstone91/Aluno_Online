...
<html lang="pt-br">
     ...
     <head>
        ...
        <title> Login - Professor Online</title>
...
<body>
	...
	<img src="imagens/logo_professor.png" class="logo">
	<div class="cadastro">
    <div class="radios"><input type="radio" onclick="aluno()" id="aluno" name="radio" class="aluno" value="Aluno"> 
        <label for="aluno" class="raspn">Aluno</label>

        <input type="radio"  class="professor" id="professor" name="radio"  value="professor" checked> 
        <label for="professor" class="raspn">Professor</label></div>
	
  	<form method="POST" action="valida_login_p.php">
           
                
               <div><input type="text" name="email" class="cadastroin" placeholder="Email"></div> 
                <p>
				
				<div>
                <div><input type="password" id="senha" name="senha" class="cadastroin" placeholder="Senha"></div>
